...
if(isset($_POST['send'])){
    if (!empty($_FILES['img']['name'])){
        ...
        set_flash_message('errors', 'Установлен аватар по умолчанию.');
        $name = 'avatar-m.png';
    }
    if ( update_img($_GET['id'], $name)){
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="img/<?=$user['img'];?>" alt="" class="img-responsive" width="200">
                                </div>
                                ...
                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button type="submit" name="send" class="btn btn-warning">Загрузить</button>
                                </div>
                            </div>
                        </div>
                    </div>
