...
if(is_not_login()){
    redirect_to("page_login.php"); exit;
}
if(isset($_POST['send'])){
    if(empty($_FILES['img'])){
    ...
    if (create_user_for_admin($_POST['name'], $_POST['work_place'], $_POST['phone_number'], $_POST['address'], $_POST['email'], $_POST['password'], $_POST['status'], $name, $_POST['vk'], $_POST['telegramm'], $_POST['instagarm'])){
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="?exit=true">Выйти</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <?php if(isset($_SESSION['errors'])):?>
                <div class="alert alert-danger text-dark" role="alert">
                    <strong>Уведомление!</strong> <?=$_SESSION['errors'];?>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="img" type="file" id="example-fileinput" class="form-control-file">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="telegramm" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="instagarm" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button type="submit" name="send" class="btn btn-success">Добавить</button>
                                    </div>
                                </div>
                            </div>
                        </div>
