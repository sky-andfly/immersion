...
if(isset($_POST['send'])){
    if ( update_general($_GET['id'],$_POST['name'], $_POST['work_place'], $_POST['phone_number'], $_POST['address'])){
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="phone_number" type="text" id="simpleinput" class="form-control" value="<?=$user['phone_number'];?>">
                                </div>
                                ...
                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button type="submit" name="send" class="btn btn-warning">Редактировать</button>
                                </div>
                            </div>
                        </div>
                    </div>
