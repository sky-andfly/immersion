...
if (isset($_GET['delete'])){
    if (!is_admin() && $_GET['delete'] != $_SESSION['id']){
        set_flash_message('errors', 'Можно редактировать только свой профиль');
        redirect_to("page_login.php"); exit;
    }
                    ...
                    <div class="col-xl-4" >
                        <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=$user['name'];?>">
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                ...
                                <span class="status status-<?=get_status($user['status'])?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/<?=$user['img'];?>'); background-size: cover;"></span>
                                </span>
                                    <div class="info-card-text flex-1">
                                        <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                            <?=$user['name'];?>
                                            <?php if(is_admin() || $_SESSION['user'] == $user['email']):?>
                            ...
                            <div class="card-body p-0 collapse show">
                                <div class="p-3" onclick=" location='page_profile.php?id=<?=$user['id'];?>';" style="cursor: pointer">
                                    <a href="tel:<?=$user['phone_number'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
